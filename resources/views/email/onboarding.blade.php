...
@section('content')
    <div style="text-transform: uppercase; font-size: 20px; padding: 15px 0; color: #4a4b48;" align="center">Добрый день, {{ $name }}!</div>
    <hr style="color: #333" />
    <p>Для Вас была создана учетная запись на ресурсе «{{ env('APP_NAME') }}»</p>
    ...
    <p style="text-align: center; color: #333;">Будем рады видеть Вас в числе наших пользователей!</p>
@endsection
